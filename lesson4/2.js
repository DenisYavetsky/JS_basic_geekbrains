...
shoppingCart.push(
    new Item('product_name_1', 'product_image_1', 95, 2)
);
shoppingCart.push(
    new Item('product_name_2', 'product_image_2', 17, 5, 10)
);
shoppingCart.push(
    new Item('product_name_3', 'product_image_3', 17.5, 6)
);
shoppingCart.push(
    new Item('product_name_4', 'product_image_4', 32, 1)
);
shoppingCart.push(
    new Item('product_name_5', 'product_image_5', 22, 10, 25)
);
